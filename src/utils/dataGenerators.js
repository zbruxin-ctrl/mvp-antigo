...
exports.gerarTelefone = gerarTelefone;
exports.gerarTelefoneFormatado = gerarTelefoneFormatado;
exports.gerarTelefoneFixo = gerarTelefoneFixo;
exports.gerarNome = gerarNome;
exports.gerarSobrenome = gerarSobrenome;
exports.gerarPayloadCompleto = gerarPayloadCompleto;
exports.gerarPayloads = gerarPayloads;
...
function gerarTelefoneFormatado() {
...
function gerarTelefoneFixo() { return gerarTelefone(); }
function gerarNome() { return rand(NOMES_MASCULINOS); }
function gerarSobrenome() { return rand(SOBRENOMES); }
/**
...
function gerarPayloadCompleto(emailAccount, inviteCode) {
...
function gerarPayloads(qtd = 5) {
    return Array.from({ length: qtd }, () => gerarPayloadCompleto());
}
//# sourceMappingURL=dataGenerators.js.map